...
export default function Contact() {
  return (
    <section id="contact" className="py-24 bg-[#2C1810]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-4xl sm:text-5xl font-bold text-[#FDF8F0] mb-4">
          Contactanos
        </h2>
        <p className="text-[#FDF8F0]/60 text-lg mb-12 max-w-xl mx-auto">
          Escribinos por WhatsApp y te asesoramos para crear el producto perfecto para vos.
        </p>
        ...
        <a
          ...
          className="inline-flex items-center gap-3 bg-[#25D366] hover:bg-[#20BD5A] text-white font-bold px-10 py-4 rounded-full text-lg transition-all hover:scale-105 shadow-lg"
        >
